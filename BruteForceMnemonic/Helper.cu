...
inline int _ConvertSMVer2Cores(int major, int minor)
{
	...
	sSMtoCores nGpuArchCoresPerSM[] =
	{
		...
		{ 0x40, 128 }, // Maxwell Generation (SM 5.0) GM10x class
		{ 0x50, 128 }, // Maxwell Generation (SM 5.2) GM20x class
		{ 0x60, 64  }, // Pascal Generation (SM 6.0) GP100 class
		{ 0x61, 128 }, // Pascal Generation (SM 6.1) GP10x class
		{ 0x62, 128 }, // Pascal Generation (SM 6.2) GP10x class
		{ 0x70, 64  }, // Volta Generation (SM 7.0) GV100 class
		{ 0x72, 64  }, // Turing Generation (SM 7.5) TU10x class
...
int devicesInfo(void)
{
	...
	for (dev = 0; dev < deviceCount; ++dev)
	{
		...
		if (cuErr == cudaSuccess) {
			printf("| Memory: %s out of %s is free.\r\n", tools::formatPrefix(freeMem / 1024.0 / 1024.0).c_str()
				, tools::formatPrefix (totalMem / 1024.0 / 1024.0));
		}
		else {
